...
int main( ){
    ...
    while (((p1.getBookSize() <= 13) && (p2.getBookSize() <= 13)) && !((p1.getBookSize()+p2.getBookSize()) == 26)) {  //game ends when one player has more than 13 books or all 26 books formed
        ...
        // while true, remove the card of the same rank from p2's hand and add to p1's hand
        ...
        // while true, remove the card of the same rank from p1's hand and add to p2's hand
